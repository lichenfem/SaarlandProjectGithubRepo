...
%=========================================================================%	
	nx = max(size(x));                                                     % nx: number of points in x direction
	ny = max(size(y));                                                     % ny: number of points in y direction
	
	N = nx * ny;                                                           % N: total number of nodes
	M = 2 * (nx - 1) * (ny - 1);                                           % total number of tri elem, each quad is divided into two tri
